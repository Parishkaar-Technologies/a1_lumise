...
jQuery(document).ready(function ($) {
    ...
    if (!document.getElementById('a1_line_form')) {
      const html = `
        ...
        <div style="display: flex; align-items: center; margin-bottom: 10px;">
          ...
          <input type="range" id="a1_edit_rows" min="1" max="50" value="10" style="flex: 1;">
          <span id="a1_rows_val" style="width: 30px; text-align: right;">10</span>
        </div>

        <div style="display: flex; align-items: center; margin-bottom: 10px;">
          <label style="width: 130px;">Columns</label>
          <input type="range" id="a1_edit_cols" min="1" max="50" value="10" style="flex: 1;">
          <span id="a1_cols_val" style="width: 30px; text-align: right;">10</span>
        </div>
  ...
  function initA1Designer(canvas) {
    ...
    // a1_dotgrid_colorInput?.addEventListener("input", () => {
    //   const newColor = a1_dotgrid_colorInput.value;

    //   if (window._a1_active_group && window._a1_active_group._objects) {
    //     window._a1_active_group._objects.forEach(dot => {
    //       dot.set("fill", newColor);
    //     });
    //     lumise.stage().canvas.renderAll();
    //   }
    // });
    ...
    canvas.on('object:moving', function (e) {
      ...
      const currentWidth = parseInt(widthInput?.value || '0', 10);
      const currentLines = parseInt(linesInput?.value || '0', 10);
      const spacing = parseInt(spacingInput?.value || '0', 10);
