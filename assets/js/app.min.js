...
jQuery(document).ready(function ($) {
  ...
  function injectA1ModalsIfMissing() {
    if (!document.getElementById('a1_line_form')) {
      const html = `
        <div id="a1_modal_overlay" style="display: none; position: fixed; inset: 0; background: rgba(0, 0, 0, 0.5); z-index: 99999;"></div>
  ...
  if (document.querySelector('li[data-tool="custom-save-load"]') === null) {
    ...
    if (navLeft) {
      ...
      nameInput.placeholder = "Give a Name to Your Design";
