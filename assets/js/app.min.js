  ...
  function initA1Designer(canvas) {
    ...
    canvas.on('mouse:down', function (e) {
      ...
      // a1_rows_val, a1_cols_val, a1_spacing_x_val, a1_spacing_y_val, a1_dot_radius_val,
          ...
          document.getElementById("a1_edit_dot_color").value = meta.color || "#000000";
    ...
    document.getElementById("a1_dotgrid")?.addEventListener("click", function () {
      ...
      document.getElementById("a1_edit_dot_color").value = defaultMeta.color;
    ...
    ['rows', 'cols', 'spacing_x', 'spacing_y', 'dot_radius'].forEach(field => {
      ...
      input?.addEventListener('input', () => {
        ...
        const meta = {
          ...
          color: document.getElementById("a1_edit_dot_color")?.value || "#000000"  // ✅ Add this
    ...
    document.getElementById("a1_cancel_dotted")?.addEventListener("click", () => {
      document.getElementById("a1_modal_overlay").style.display = "none";
      document.getElementById("a1_edit_dotted_form").style.display = "none";
    });

    document.getElementById("a1_delete_dotted")?.addEventListener("click", () => {
      const group = window._a1_active_dotted;
      if (group && lumise.stage().canvas.contains(group)) {
        lumise.stage().canvas.remove(group);
        lumise.stage().canvas.renderAll();
      }

      window._a1_active_dotted = null;
      document.getElementById("a1_modal_overlay").style.display = "none";
      document.getElementById("a1_dotgrid_form").style.display = "none";
    });
